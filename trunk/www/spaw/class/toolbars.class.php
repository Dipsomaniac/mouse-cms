...
class SPAW_TB_Image extends SPAW_TB_Item
{
  ...
  function get()
  {
    ...
    if (!empty($this->name))
    {
      $buf = '<img id="SPAW_'.$this->editor.'_tb_'.$this->name.'" alt="'.$this->lang->m('title',$this->name).'" src="'.$GLOBALS['spaw_dir'].'lib/themes/'.$this->theme.'/img/tb_'.$this->name.'.gif" '.(isset($this->attributes)?$this->attributes:'').' unselectable="on">';
      return $buf;
    }
  }
} // SPAW_TB_Image
...
class SPAW_TB_Button extends SPAW_TB_Item
{
  ...
  function get()
  {
    if (!empty($this->name))
    {
      $buf = '<img id="SPAW_'.$this->editor.'_tb_'.$this->name.'" alt="'.$this->lang->m('title',$this->name).'" src="'.$GLOBALS['spaw_dir'].'lib/themes/'.$this->theme.'/img/tb_'.$this->name.'.gif" onClick="SPAW_'.$this->name.'_click(\''.$this->editor.'\',this)" class="SPAW_'.$this->theme.'_tb_out" onMouseOver="SPAW_'.$this->theme.'_bt_over(this)" onMouseOut="SPAW_'.$this->theme.'_bt_out(this)" onMouseDown="SPAW_'.$this->theme.'_bt_down(this)" onMouseUp="SPAW_'.$this->theme.'_bt_up(this)"  '.(isset($this->attributes)?$this->attributes:'').' unselectable="on">';
      return $buf;
    }
  }
} // SPAW_TB_Button
...
class SPAW_Toolbars
{
  ...
  function setMode($value)
  {
    ...
    if ($value == '')
    {
      $this->mode = $GLOBALS['spaw_default_toolbars'];
    }
    else
    {
      $this->mode = $value;
    ...
    if (!@include($GLOBALS['spaw_root'].'lib/toolbars/'.$this->mode.'/'.$this->mode.'_toolbar_data.'.strtolower(SPAW_Util::getBrowser()).'.inc.php'))
    {
      if (!@include($GLOBALS['spaw_root'].'lib/toolbars/'.$this->mode.'/'.$this->mode.'_toolbar_data.inc.php'))
      {
        // load default toolbar data
        @include($GLOBALS['spaw_root'].'lib/toolbars/'.$GLOBALS['spaw_default_toolbars'].'/'.$GLOBALS['spaw_default_toolbars'].'_toolbar_data.inc.php');
      }
    }
  ...
  function SPAW_Toolbars(&$lang, $editor, $mode='', $theme='', $dropdown_data='')
  {
    ...
    {
      $this->dropdown_data = $GLOBALS['spaw_dropdown_data'];
    }
  }
